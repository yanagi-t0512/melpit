...
<div class="container">
    ...
    <div class="row">
        <div class="col-8 offset-2 bg-white">
            ...
            <div class="font-weight-bold text-center border-bottom pb-3 pt-3"
                style="font-size: 24px">商品を出品する</div>
            ...
            <form method="POST" action="{{ route('sell') }}" class="p-5" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                        name="description" required autocomplete="description" autofocus>{{ old('dscription') }}
                    </textarea>
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="condition" class="custom-select form-control @error('condition') is-invalid @enderror">
                        @foreach ($conditions as $condition)
                            <option value="{{$condition->id}}" {{old('contidion') == $condition->id ? 'selected' : ''}}>
                                {{$condition->name}}
                            </option>
                        @endforeach
                    </select>
